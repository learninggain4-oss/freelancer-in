...
const BottomTabBar = ({ userType, onMenuClick, theme = "black" }: BottomTabBarProps) => {
  ...
  const barBdr    = isDark ? "rgba(255,255,255,.07)"      : isWarm ? "rgba(180,83,9,.12)"    : isForest ? "rgba(21,128,61,.12)"   : "rgba(0,0,0,.09)";
  const activeC   = isDark ? "#a5b4fc"                    : isWarm ? "#d97706"                : isForest ? "#16a34a"               : "#4f46e5";
  const inactC    = isDark ? "rgba(255,255,255,.32)"      : isWarm ? "rgba(120,113,108,.55)"  : isForest ? "rgba(75,124,93,.55)"   : "#9ca3af";
  const activePill = isDark ? "rgba(99,102,241,.2)"       : isWarm ? "rgba(217,119,6,.15)"    : isForest ? "rgba(22,163,74,.15)"   : "rgba(99,102,241,.12)";
  const labelActive = isDark ? "#a5b4fc"                  : isWarm ? "#d97706"                : isForest ? "#16a34a"               : "#4f46e5";
  const labelInact  = isDark ? "rgba(255,255,255,.28)"    : isWarm ? "rgba(120,113,108,.5)"   : isForest ? "rgba(75,124,93,.5)"    : "#9ca3af";
  ...
  return (
    <nav style={{
      ...
      boxShadow: isDark ? "0 -8px 32px rgba(0,0,0,.4)" : isWarm ? "0 -4px 20px rgba(180,83,9,.08)" : isForest ? "0 -4px 20px rgba(21,128,61,.08)" : "0 -4px 20px rgba(0,0,0,.08)",
    }}>
