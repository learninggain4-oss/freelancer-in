...
const BottomTabBar = ({ userType, onMenuClick, theme = "black" }: BottomTabBarProps) => {
  ...
  return (
    <nav style={{
      ...
      <div style={{ display: "flex", alignItems: "stretch", height: 76, maxWidth: 600, margin: "0 auto", padding: "0 2px" }}>
        {tabs.map(tab => {
        ...
        <button onClick={onMenuClick}
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", width: 46, height: 36, borderRadius: 12 }}>
