...
const ClientProfile = () => {
  ...
  const sections = [
    { icon: User, label: "Personal Information", path: "/client/profile/personal", color: "text-primary" },
    { icon: Briefcase, label: "Professional", path: "/client/profile/professional", color: "text-accent" },
    { icon: Landmark, label: "Bank Details", path: "/client/profile/bank-details", color: "text-warning" },
    { icon: Building2, label: "Work Experience", path: "/client/profile/work-experience", color: "text-secondary" },
    { icon: Briefcase, label: "Services", path: "/client/profile/services", color: "text-primary" },
    { icon: AlertCircle, label: "Emergency Contacts", path: "/client/profile/emergency-contacts", color: "text-destructive" },
    {
      icon: ShieldCheck,
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="flex items-center gap-2 text-2xl font-bold text-foreground">
            {Array.isArray(profile?.full_name) ? profile.full_name.join(" ") : profile?.full_name ?? "Client"}
