  ...
  return (
    <div className="space-y-4 pb-20">
      ...
      <PhotoCaptureDialog
        ...
        onCaptured={handleCheckInPhoto}
        title="Check In Photo"
        description="Take a photo to verify your check-in."
      />

      <PhotoCaptureDialog
        open={showCheckOutDialog}
        onOpenChange={setShowCheckOutDialog}
        onCaptured={handleCheckOutPhoto}
        title="Check Out Photo"
        description="Take a photo to verify your check-out."
      />
    </div>
  );
};
