  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <section className="relative overflow-hidden px-4 pb-12 pt-16 sm:px-6 md:pb-20 md:pt-24">
        <video autoPlay loop muted playsInline className="absolute inset-0 -z-20 h-full w-full object-cover" src="/hero-bg.mp4" />
        <div className="absolute inset-0 -z-10 bg-background/85 backdrop-blur-[2px]" />
        <div className="absolute -right-32 -top-32 -z-[5] h-96 w-96 rounded-full bg-primary/5 blur-3xl" style={{ transform: `translate(${scrollY * -0.08}px, ${scrollY * 0.25}px)` }} />
        <div className="absolute -bottom-32 -left-32 -z-[5] h-96 w-96 rounded-full bg-accent/5 blur-3xl" style={{ transform: `translate(${scrollY * 0.1}px, ${scrollY * -0.2}px)` }} />
