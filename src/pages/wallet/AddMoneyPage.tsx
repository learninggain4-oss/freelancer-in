...
import {
  ...
  Zap, AlertCircle, ChevronRight, Loader2, Gift,
} from "lucide-react";
                ...
                value: (
                  <div className="flex items-center gap-2">
                    {selectedMethodData?.logo_path ? (
                      <img src={getLogoUrl(selectedMethodData.logo_path)} alt={selectedMethod} className="h-5 w-5 rounded-sm object-contain" />
                    ) : (
