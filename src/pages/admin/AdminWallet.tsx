...
const AdminWallet = () => {
  ...
  return (
    <div className="min-h-screen p-4 pb-20 space-y-6" style={{ background: T.bg }}>
      <div className="rounded-3xl bg-gradient-to-br from-indigo-600 to-violet-700 p-8 text-white shadow-2xl">
        <h2 className="text-3xl font-bold">Personal Wallet</h2>
        <p className="mt-2 text-indigo-100">Manage funds and internal transfers.</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <div className="rounded-3xl border p-6" style={{ background: T.card, borderColor: T.border }}>
          <div className="mb-4 flex items-center gap-3 font-bold" style={{ color: T.text }}>
            <PlusCircle className="text-indigo-500" /> Add Money
          </div>
          <Input
            type="number"
            value={addAmount}
        ...
        <div className="rounded-3xl border p-6" style={{ background: T.card, borderColor: T.border }}>
          <div className="mb-4 flex items-center gap-3 font-bold" style={{ color: T.text }}>
            <Pencil className="text-amber-500" /> Edit Balance
          </div>
          <Input
            type="number"
            value={editAmount}
      ...
      {/* Transfer Section (Keep your existing transfer UI here) */}
