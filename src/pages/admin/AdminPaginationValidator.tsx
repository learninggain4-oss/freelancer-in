...
const seed=():PageCheck[]=>[
  {id:"p1",name:"Job Listings",endpoint:"/api/jobs",pageSize:20,totalRecords:4510,duplicates:0,missing:0,loadMs:82,status:"ok"},
  {id:"p2",name:"Transactions",endpoint:"/api/wallet/tx",pageSize:50,totalRecords:84200,duplicates:4,missing:0,loadMs:240,status:"issue"},
  {id:"p3",name:"User Search",endpoint:"/api/users/search",pageSize:25,totalRecords:12840,duplicates:0,missing:2,loadMs:140,status:"issue"},
  {id:"p4",name:"Notifications",endpoint:"/api/notifications",pageSize:100,totalRecords:215000,duplicates:0,missing:0,loadMs:65,status:"ok"},
];
