...
const EmployerWallet = () => {
  ...
  const base = location.pathname.startsWith("/employer") ? "/employer" : "/employer";
  ...
  return (
    <div style={{ background: T.bg, minHeight: "100vh", color: T.text }} className="space-y-6 p-4 pb-24">
      ...
      <div
        ...
        className="relative overflow-hidden rounded-3xl p-6 text-white shadow-2xl animate-fade-in-up"
      >
      ...
      {!(profile as any)?.wallet_active && (
        <div
          ...
          className="flex items-start gap-4 rounded-2xl border p-5 text-sm text-[#f87171] animate-fade-in-up shadow-lg backdrop-blur-md"
        >
          ...
          <div className="flex-1">
            ...
            <p className="font-medium opacity-90 leading-relaxed">
              Your wallet is currently inactive. Withdrawals are disabled. Please contact command center.
            </p>
          </div>
        </div>
      )}
