...
const EmployeeProfile = () => {
  ...
  const fullName = Array.isArray(profile?.full_name)
  ...
  const sections = [
    {
      ...
      path: "/freelancer/profile/personal",
      color: "#6366f1",
    ...
    },
    {
      icon: Briefcase,
      label: "Professional",
      path: "/freelancer/profile/professional",
      color: "#8b5cf6",
    ...
    },
    {
      icon: Landmark,
      label: "Bank Details",
      path: "/freelancer/profile/bank-details",
    ...
    },
    {
      ...
      path: "/freelancer/profile/upi-apps",
      color: isDark ? "#a78bfa" : "#7c3aed",
      desc: "Manage UPI apps",
    },
    {
      icon: Building2,
      label: "Work Experience",
      path: "/freelancer/profile/work-experience",
    ...
    },
    {
      icon: Star,
      label: "Services",
      path: "/freelancer/profile/services",
      color: isDark ? "#4ade80" : "#16a34a",
      desc: `${servicesCount ?? 0} services listed`,
    },
    {
      icon: AlertCircle,
      label: "Emergency Contacts",
      path: "/freelancer/profile/emergency-contacts",
  ...
  return (
    <div style={{ background: T.bg, minHeight: "100vh", color: T.text }} className="space-y-5 p-4 pb-24">
        ...
        <CardContent className="relative px-4 pb-6 pt-0">
          <div className="flex flex-col items-center -mt-14">
            <div
              ...
              className="rounded-full border-[6px] shadow-xl overflow-hidden"
            >
              <ProfilePhotoUpload />
            </div>
            ...
            <div className="mt-2 flex items-center gap-2">
              <Badge
                style={{ background: T.badge, color: T.badgeFg, borderColor: T.border }}
                variant="outline"
      ...
      >
        {(profile as any)?.username && (
          <div className="px-5 pt-4">
            <p style={{ color: "rgba(255,255,255,.75)" }} className="text-[10px] uppercase tracking-widest font-bold">
              Username
            </p>
      ...
      >
        <CardContent className="p-5">
          <div className="mb-2 flex items-center justify-between">
            <span style={{ color: T.text }} className="text-sm font-bold uppercase tracking-wider opacity-80">
              Profile Mastery
            </span>
            <span style={{ color: completionColor }} className="text-2xl font-black">
              {completion}%
            </span>
          </div>
          <div className="mb-4 flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-amber-400">+{rewardCoins ?? 1000} Coins on 100% completion</span>
          </div>
          ...
          {completion < 100 ? (
            <p style={{ color: T.sub }} className="mt-4 text-[11px] leading-relaxed">
              Unlock your full potential! Complete all sections to earn rewards and gain higher visibility among
              employers.
            </p>
          ) : (
      ...
      {/* Navigation Menu */}
      <div className="pt-2">
        <h2 style={{ color: T.sub }} className="mb-4 text-xs font-black uppercase tracking-[0.2em] px-1">
          Control Panel
        </h2>
          ...
          {sections.map((section, idx) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <span style={{ color: T.text }} className="block text-sm font-bold tracking-tight">
                  {section.label}
                </span>
                <span style={{ color: T.sub }} className="block text-[11px] font-medium opacity-80">
                  {section.desc}
                </span>
              </div>
